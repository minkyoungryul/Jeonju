...
public final static String _SERVICE_KEY = "iFwliBu1jhkPtsNQA1gvnrmONFzxyPQzcTSKFnY8rlgryyZ8scW8wzL6m89bOipf7mBo/dptZLTDyvNH1dKCbQ==";
    public final static String _SERVER_REQUEST_URL = "bus_location2_stopnm_common.do";
    public final static String _ALL_BUS_STOP_URL = "bus_location2_stopnm_common.do?ServiceKey=" + _SERVICE_KEY;
}
